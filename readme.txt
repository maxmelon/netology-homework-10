...
Интерфейс класса используется в том случае, когда необходимо установить, к каким методам класса можно будет обращаться из внешней программы. Все из определенных методов должны будут присутствовать в классе, который имплементирует этот интерфейс.
В отличие от интерфейса, в рамках которого вообще не допускается установление какой-либо реализации методов, абстрактный класс может сочетать методы с реализацией и без нее (абстрактные). Определение абстрактных классов разумно в случаях, когда на этапе родительской структуры нужно жестко задать, какие из методов, которые не могут быть установлены сразу в родительском классе, должны быть обязательно реализованы в наследующем от него дочернем классе.
